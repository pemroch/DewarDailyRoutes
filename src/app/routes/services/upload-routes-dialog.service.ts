...
// Shared Models
import { Rate, Route } from '@shared/models';
// Module Services
import { RoutesTableService } from '../services/routes-table.service';

@Injectable()
export class UploadRoutesDialogService {
    ...
    uploadRoutes(props: { $event: any, rate: Rate }) {
        ...
        if (input.files.length) {
            ...
            const onloadend = _ => {
                ...
                const newRoutes = this.setupRoutes(routes, props.rate);
