        ...
        <div *ngIf="this.dataSource.data?.length" id="container">
            <mat-table #table [dataSource]="this.dataSource" matSort>
                ...
                <ng-container matColumnDef="customers">
                    ...
                    <mat-cell *matCellDef="let route" class="block" mat-cell>
                        <ng-container *ngFor="let customerId of route.customers">
                            <div class="capitalize">{{ this.customers && customerId ? this.customers[customerId].name : null }}</div>
                        </ng-container>
                    </mat-cell>
                </ng-container>
                ...
                <ng-container matColumnDef="truck">
                    ...
                    <mat-cell *matCellDef="let route" mat-cell>
                        <div>{{ this.trucks && route.truck ? this.trucks[route.truck].name : null }}</div>
                    </mat-cell>
                </ng-container>
                ...
                <ng-container matColumnDef="trailer">
                    ...
                    <mat-cell *matCellDef="let route" mat-cell>
                        <div>{{ this.trailers && route.trailer ? this.trailers[route.trailer].name : null }}</div>
                    </mat-cell>
                </ng-container>
                ...
                <ng-container matColumnDef="driver">
                    ...
                    <mat-cell *matCellDef="let route" mat-cell>
                        <div class="capitalize">{{ this.drivers && route.driver ? this.drivers[route.driver].name : null }}</div>
                    </mat-cell>
                </ng-container>
                    ...
                    <mat-cell *matCellDef="let route" class="block" mat-cell>
                        <ng-container *ngFor="let pickUpItemId of route.pickUpItems">
                            <div class="capitalize">
                                {{ this.pickUpItems && pickUpItemId ? this.pickUpItems[pickUpItemId].name : null }}
                            </div>
                        </ng-container>
                    </mat-cell>
                </ng-container>
                ...
                <ng-container matColumnDef="loadLocation">
                    ...
                    <mat-cell *matCellDef="let route" mat-cell>
                        <div class="capitalize">
                            {{ this.locations && route.loadLocation ? this.locations[route.loadLocation].name : null }}
                        </div>
                    </mat-cell>
                </ng-container>
