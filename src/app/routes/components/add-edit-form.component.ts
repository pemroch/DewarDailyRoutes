    ...
    template: `
        <form #form="ngForm" *ngIf="this.route">
                ...
                <mat-form-field fxFlex.gt-xs="50" fxFlex.gt-md="40">
                    ...
                    <span matSuffix>
                        <button
                            ...
                            [disabled]="this.pending || !this.route.loadDate"
                            color="warn"
                            mat-icon-button
                        >
                ...
                <mat-form-field fxFlex.gt-xs="50" fxFlex.gt-md="40">
                    ...
                    <span matSuffix>
                        <button
                            ...
                            [disabled]="this.pending || !this.route.driverEta"
                            color="warn"
                            mat-icon-button
                        >
                            <mat-icon>clear</mat-icon>
            ...
            <ng-container *ngFor="let customer of this.customers; let i=index">
                <mat-checkbox
                    (change)="this.checkBoxChanged.emit({ array: this.route.customers, value: customer })"
                    [checked]="this.isSelected({ arr: this.route.customers, item: customer})"
                    [disabled]="this.pending"
                    name="{{ customer.id }}"
                    class="capitalize"
                >
            ...
            <ng-container *ngFor="let pickUpItem of this.pickUpItems">
                <mat-checkbox
                    (change)="this.checkBoxChanged.emit({ array: this.route.pickUpItems, value: pickUpItem })"
                    [checked]="this.isSelected({ arr: this.route.pickUpItems, item: pickUpItem })"
                    [disabled]="this.pending"
                    name="{{ pickUpItem.id }}"
                    class="capitalize"
                >
                ...
                <div *ngIf="this.isSelected({ arr: this.route.pickUpItems, item: pickUpItem })" fxLayout.xs="column">
                    <mat-form-field fxFlex.gt-xs="33">
                        <input
                            #itemRef
                            (change)="this.pickUpItemRateChange.emit({
                                arr: this.route.pickUpItems,
                                item: pickUpItem,
                                value: itemRef.value
                            })"
                            [value]="this.pickUpItemRate({ arr: this.route.pickUpItems, item: pickUpItem})"
                            [disabled]="this.pending"
                            type="number"
                            placeholder="Pick Up Rate"
                            autocorrect="off"
                            autocomplete="off"
                            matInput
                        />
...
export class AddEditFormComponent {
    ...
    @Output() pickUpItemRateChange = new EventEmitter();
